@extends('layouts/app', ['activePage' => 'login', 'title' => 'Piattaforma Consultazione Contenuti Multimediali'])
                            ...
                            <div class="card-body ">
                                <div class="card-body">
                                    <div class="form-group">
                                        <label for="nome_utente" class="col-md-6 col-form-label">{{ __('Username') }}</label>

                                        <div class="col-md-14">
                                            <input id="nome_utente" type="text" class="form-control @error('username') is-invalid @enderror" name="nome_utente" value="{{ old('username', 'admin') }}" required autocomplete="username" autofocus>
